...
const SingleProfile = () => {
  ...
  const [{ loading, error, profile }, dispatch] = useReducer(profilesReducer, {
    loading: false,
    profile: {},
    error: "",
  });
        ...
        <div class="flex lg:flex-row flex-col widget card mt-3 items-center p-4 lg:space-x-2">
          ...
          <div class="lg:w/6/6 flex flex-col p-4 lg:items-start items-center">
            ...
            <p class="lg:text-left mb-2 text-left dark:text-gray-100">
              ...
              imperdiet doming id quod mazim placerat facer possim assum Nam
          ...
          <div class="md:flex md:space-x-6">
              ...
              <div class="widget card pt-4 pl-5 pr-5 pb-4">
                ...
                <ul class="text-gray-600 space-y-3 mt-4">
                  ...
                  <li class="flex items-center space-x-2">
                    ...
                    Living In <strong> Chennai , Tamil Nadu, India </strong>
                  </li>
                </ul>
                <hr />
                ...
                <hr />
                <h5 class="text-lg font-semibold mt-4">About my Family</h5>
                Family Type
              </div>
            </div>
            ...
            <div class="w-full space-y-6">
              <div class="widget card pt-4 pl-5 pr-5 pb-1">
                <h5 class="text-lg font-semibold">Professional Information</h5>
                <ul class="text-gray-600 space-y-3 mt-4">
                  <li class="flex items-center space-x-2">
                  ...
                  <li class="flex items-center space-x-2">
                    <MdOutlineLocationOn class="rounded-full bg-gray-200 text-2xl p-1 mr-3" />
                    Working In <strong> Chennai , Tamil Nadu, India </strong>
                  </li>
                </ul>
                <hr />
                ...
                <hr />
                <h5 class="text-lg font-semibold mt-4">Partner Preferences</h5>
                <ul class="text-gray-600 space-y-3 mt-4">
                  <li class="flex items-center space-x-2">
                    <FaElementor class="rounded-full bg-gray-200 text-2xl p-1 mr-3" />
